...
# - 2019 added slots for better memory management by s-leger at blender-archipack.org
#
# Calculate Delaunay triangulation for a set of 2D input points.
#
...
class Context(object):
    ...
    __slots__=('doPrint', 'debug', 'extent', 'triangulate', 'vertices', 'lines', 'edges', 'triangles', 'polygons')
...
class EdgeList(object):
    ...
    __slots__ = ('hashsize', 'xmin', 'deltax', 'hash', 'leftend', 'rightend')
...
class PriorityQueue(object):
    ...
    __slots__ = ('ymin', 'deltay', 'hashsize', 'count', 'minidx', 'hash')
...
class SiteList(object):
    ...
    __slots__ = ('__sites', '__sitenum', '__xmin', '__ymin', '__xmax', '__ymax', '__extent')
