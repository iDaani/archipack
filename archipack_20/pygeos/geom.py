...
class Point(Geometry, Puntal):
     ...
     *
    """
    # __slots__ = ('_factory', 'geometryChangedFilter', 'has_z', '_env', 'coord')
...
class LineString(Geometry, Lineal):
     ...
     *  an ValueError
    """
    # __slots__ = ('_factory', 'geometryChangedFilter', 'has_z', '_env', '_coords')
...
class GeometryCollection(Geometry):
    ...
    # __slots__ = ('_factory', 'geometryChangedFilter', 'has_z', '_env', 'geoms')
