...
from .archipack_i18n import Archipacki18n
from .archipack_object import ArchipackObjectsManager, objman
    ...
    if len(animated) > 0:
        ...
        for name in animated:
            ...
            if o and o.archipack_animation:
                ...
                d.update(context)
                objman.unselect_object(context, o)
        for o in sel:
            objman.select_object(context, o)
            objman.select_object(context, act, True)
